...
install_personal() {
	echo "Installing for personal use ..."
...
install_work() {
	echo "Installing for work use..."
}

# Function to prompt the user for environment selection
select_environment() {
	while true; do
		...
		case $env_choice in
		1)
			echo "You selected Personal environment."
			install_personal
			break
			;;
		2)
			echo "You selected Work environment."
			install_work
			break
			;;
		*)
